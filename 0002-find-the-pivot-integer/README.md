<h2><a href="https://leetcode.com/problems/find-the-pivot-integer">2. Find the Pivot Integer</a></h2><h3>Easy</h3><hr><p>Given a positive integer <code>n</code>, find the <strong>pivot integer</strong> <code>x</code> such that:</p>
