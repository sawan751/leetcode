<h2><a href="https://leetcode.com/problems/smallest-integer-divisible-by-k">2. Smallest Integer Divisible by K</a></h2><h3>Medium</h3><hr><p>Given a positive integer <code>k</code>, you need to find the <strong>length</strong> of the <strong>smallest</strong> positive integer <code>n</code> such that <code>n</code> is divisible by <code>k</code>, and <code>n</code> only contains the digit <code>1</code>.</p>
